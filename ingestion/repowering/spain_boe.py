    ...
    'input_schema': {
        ...
        'properties': {
            ...
            'project_name':         {'type': 'string',
                                     'description': 'Installation name in standard English format: "{Place} Wind Farm" for onshore_wind / offshore_wind, "{Place} Solar Farm" for solar_pv, "{Place} BESS" for bess. Preserve local accents on the place name (Mudarra, Cabeza del Caballo). DO NOT include capacity, year, expediente number, or any other descriptor — capacity goes in the capacity_mw field, not the name. Examples: "Mudarra Wind Farm" (NOT "Mudarra de 100 MW Wind Farm" or "Parque Eólico Mudarra de 100 MW"), "Cabeza del Caballo Solar Farm" (NOT "Planta Solar Cabeza del Caballo de 50 MWp"), "Asturias BESS" (NOT "Sistema almacenamiento Asturias 200 MWh"). Strip the BOE notice prefix, the capacity, and any other qualifiers. Output the project as a developer would label it on a press release.'},
