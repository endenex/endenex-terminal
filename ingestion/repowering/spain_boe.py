    ...
    'input_schema': {
        ...
        'properties': {
            ...
            'project_name':         {'type': 'string',
                                     'description': 'The actual installation NAME ONLY — e.g. "Parque Eólico Mudarra" or "Planta Solar Cabeza del Caballo". Do NOT use the BOE notice headline (e.g. "Modificación del parque eólico Mudarra"); strip procedural prefixes like "Anuncio de…", "Resolución relativa al…", "Modificación del…", "Solicitud de autorización para…". Just the project name as a developer would refer to it.'},
