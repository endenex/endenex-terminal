    ...
    'input_schema': {
        ...
        'properties': {
            ...
            'project_name':       {'type': 'string',
                                   'description': 'The actual installation NAME ONLY — e.g. "Parc Éolien de Saint-Crépin" or "Centrale Photovoltaïque de Cestas". Do NOT use the consultation headline; strip procedural prefixes like "Projet de…", "Demande d\'autorisation pour…", "Renouvellement du…", "Modification de…". Just the project name as a developer would refer to it.'},
