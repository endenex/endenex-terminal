    ...
    'input_schema': {
        ...
        'properties': {
            ...
            'project_name':       {'type': 'string',
                                   'description': 'Installation name in standard English format: "{Place} Wind Farm" for onshore_wind / offshore_wind, "{Place} Solar Farm" for solar_pv, "{Place} BESS" for bess. Preserve local accents on the place name (Saint-Crépin, Cestas, Île-d\'Yeu). DO NOT include capacity, year, dossier number, or any other descriptor — capacity goes in the capacity_mw field, not the name. Examples: "Saint-Crépin Wind Farm" (NOT "Saint-Crépin 25 MW Wind Farm" or "Parc Éolien de Saint-Crépin de 25 MW"), "Cestas Solar Farm" (NOT "Centrale Photovoltaïque de Cestas 300 MW"), "Île-d\'Yeu Wind Farm" (NOT "Parc éolien en mer de l\'île d\'Yeu 500 MW"). Strip procedural consultation prefix, capacity, and any other qualifiers. Output the project as a developer would label it on a press release.'},
