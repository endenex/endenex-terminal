    ...
    'input_schema': {
        ...
        'properties': {
            ...
            'project_name':       {'type': 'string',
                                   'description': 'Installation name in standard English format: "{Place} Wind Farm" for onshore_wind / offshore_wind, "{Place} Solar Farm" for solar_pv, "{Place} BESS" for bess. Preserve local accents on the place name (Saint-Crépin, Cestas, Île-d\'Yeu). Examples: "Saint-Crépin Wind Farm" (not "Parc Éolien de Saint-Crépin" or "Projet de parc éolien de Saint-Crépin"), "Cestas Solar Farm" (not "Centrale Photovoltaïque de Cestas"), "Île-d\'Yeu Wind Farm" (not "Parc éolien en mer de l\'île d\'Yeu"). Strip procedural consultation prefixes entirely; output the project as a developer would label it on a press release.'},
